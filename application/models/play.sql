BEGIN
    ...
    TRUNCATE opuzen_dev_master_app.PORTFOLIO_PICTURE;
    INSERT INTO opuzen_dev_master_app.PORTFOLIO_PICTURE
    SELECT * FROM opuzen_prod_master_app.PORTFOLIO_PICTURE;

    TRUNCATE opuzen_dev_master_app.PORTFOLIO_PRODUCT;
    INSERT INTO opuzen_dev_master_app.PORTFOLIO_PRODUCT
    SELECT * FROM opuzen_prod_master_app.PORTFOLIO_PRODUCT;

    TRUNCATE opuzen_dev_master_app.PORTFOLIO_PROJECT;
    INSERT INTO opuzen_dev_master_app.PORTFOLIO_PROJECT
    SELECT * FROM opuzen_prod_master_app.PORTFOLIO_PROJECT;

    TRUNCATE opuzen_dev_master_app.S_HISTORY_PORTFOLIO_PICTURES;
    INSERT INTO opuzen_dev_master_app.S_HISTORY_PORTFOLIO_PICTURES
    SELECT * FROM opuzen_prod_master_app.S_HISTORY_PORTFOLIO_PICTURES;

    TRUNCATE opuzen_dev_master_app.S_HISTORY_PORTFOLIO_PRODUCT;
    INSERT INTO opuzen_dev_master_app.S_HISTORY_PORTFOLIO_PRODUCT
    SELECT * FROM opuzen_prod_master_app.S_HISTORY_PORTFOLIO_PRODUCT;

    TRUNCATE opuzen_dev_master_app.S_HISTORY_PORTFOLIO_PROJECT;
    INSERT INTO opuzen_dev_master_app.S_HISTORY_PORTFOLIO_PROJECT
    SELECT * FROM opuzen_prod_master_app.S_HISTORY_PORTFOLIO_PROJECT;
    ...
    TRUNCATE opuzen_dev_master_app.P_CLEANING_INSTRUCTIONS;
    INSERT INTO opuzen_dev_master_app.P_CLEANING_INSTRUCTIONS
    SELECT * FROM opuzen_prod_master_app.P_CLEANING_INSTRUCTIONS;

    TRUNCATE opuzen_dev_master_app.P_CLEANING_INSTRUCTIONS_FILES;
    INSERT INTO opuzen_dev_master_app.P_CLEANING_INSTRUCTIONS_FILES
    SELECT * FROM opuzen_prod_master_app.P_CLEANING_INSTRUCTIONS_FILES;
    ...
    TRUNCATE opuzen_dev_master_app.P_PRODUCT_TASK;
    INSERT INTO opuzen_dev_master_app.P_PRODUCT_TASK
    SELECT * FROM opuzen_prod_master_app.P_PRODUCT_TASK;

    TRUNCATE opuzen_dev_master_app.P_RESTOCK_STATUS;
    INSERT INTO opuzen_dev_master_app.P_RESTOCK_STATUS
    SELECT * FROM opuzen_prod_master_app.P_RESTOCK_STATUS;

    TRUNCATE opuzen_dev_master_app.P_SAMPLING_LOCATIONS;
    INSERT INTO opuzen_dev_master_app.P_SAMPLING_LOCATIONS
    SELECT * FROM opuzen_prod_master_app.P_SAMPLING_LOCATIONS;
    ...
    TRUNCATE opuzen_dev_master_app.P_WEIGHT_UNIT;
    INSERT INTO opuzen_dev_master_app.P_WEIGHT_UNIT
    SELECT * FROM opuzen_prod_master_app.P_WEIGHT_UNIT;
    ...
    TRUNCATE opuzen_dev_master_app.RESTOCK_ORDER;
    INSERT INTO opuzen_dev_master_app.RESTOCK_ORDER
    SELECT * FROM opuzen_prod_master_app.RESTOCK_ORDER;

    TRUNCATE opuzen_dev_master_app.RESTOCK_ORDER_COMPLETED;
    INSERT INTO opuzen_dev_master_app.RESTOCK_ORDER_COMPLETED
    SELECT * FROM opuzen_prod_master_app.RESTOCK_ORDER_COMPLETED;

    TRUNCATE opuzen_dev_master_app.RESTOCK_SHIP;
    INSERT INTO opuzen_dev_master_app.RESTOCK_SHIP
    SELECT * FROM opuzen_prod_master_app.RESTOCK_SHIP;

    TRUNCATE opuzen_dev_master_app.RESTOCK_SHIP_COMPLETED;
    INSERT INTO opuzen_dev_master_app.RESTOCK_SHIP_COMPLETED
    SELECT * FROM opuzen_prod_master_app.RESTOCK_SHIP_COMPLETED;
    ...
    TRUNCATE opuzen_dev_master_app.S_HISTORY_ITEM_SHELF;
    INSERT INTO opuzen_dev_master_app.S_HISTORY_ITEM_SHELF
    SELECT * FROM opuzen_prod_master_app.S_HISTORY_ITEM_SHELF;
    ...
    TRUNCATE opuzen_dev_master_app.S_HISTORY_PRODUCT_TASK;
    INSERT INTO opuzen_dev_master_app.S_HISTORY_PRODUCT_TASK
    SELECT * FROM opuzen_prod_master_app.S_HISTORY_PRODUCT_TASK;
    ...
    TRUNCATE opuzen_dev_master_app.S_HISTORY_PRODUCT_X_DIGITAL;
    INSERT INTO opuzen_dev_master_app.S_HISTORY_PRODUCT_X_DIGITAL
    SELECT * FROM opuzen_prod_master_app.S_HISTORY_PRODUCT_X_DIGITAL;
    ...
    TRUNCATE opuzen_dev_master_app.T_PRODUCT_CLEANING_INSTRUCTIONS;
    INSERT INTO opuzen_dev_master_app.T_PRODUCT_CLEANING_INSTRUCTIONS
    SELECT * FROM opuzen_prod_master_app.T_PRODUCT_CLEANING_INSTRUCTIONS;
    ...
    TRUNCATE opuzen_dev_master_app.T_PRODUCT_CONTENT_BACK_DESCR;
    INSERT INTO opuzen_dev_master_app.T_PRODUCT_CONTENT_BACK_DESCR
    SELECT * FROM opuzen_prod_master_app.T_PRODUCT_CONTENT_BACK_DESCR;
    ...
    TRUNCATE opuzen_dev_master_app.T_PRODUCT_CONTENT_FRONT_DESCR;
    INSERT INTO opuzen_dev_master_app.T_PRODUCT_CONTENT_FRONT_DESCR
    SELECT * FROM opuzen_prod_master_app.T_PRODUCT_CONTENT_FRONT_DESCR;
    ...
    TRUNCATE opuzen_dev_master_app.T_PRODUCT_TASK;
    INSERT INTO opuzen_dev_master_app.T_PRODUCT_TASK
    SELECT * FROM opuzen_prod_master_app.T_PRODUCT_TASK;
