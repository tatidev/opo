...
$config['tables']['users_showrooms']    = 'auth_users_showrooms';
$config['tables']['users_destinations']    = 'auth_users_destinations';
$config['tables']['groups_permissions']  = 'auth_groups_permissions';

$config['tables']['login_attempts']  = 'auth_login_attempts';
$config['tables']['permissions']    = 'auth_permissions';
 ...
 */
$config['site_title']                 = "Opuzen System";       // Site Title, example.com
$config['admin_email']                = "edonovan@opuzen.com"; // Admin Email, admin@example.com
$config['default_group']              = 'basic';           // Default group, use name
...
$config['error_end_delimiter']     = '<br>';//'</p>';	// Error message end delimiter
