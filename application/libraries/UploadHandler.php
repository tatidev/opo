...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/' . $options['dir'],
            'upload_url' => $this->get_full_url().'/' . $options['dir'],
    ...
    protected function fix_file_extension($file_path, $name, $size, $type, $error,
        ...
        // echo "<br> UploadHandler::fix_file_extension() :: NAME: " . $name . "<br>";
        return $name;
    }
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        $file->name = (isset($this->options['filename']) ) 
