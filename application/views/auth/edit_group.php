  ...
  <div class='col-md-12'>
    ...
    <div class='row table-heading'>
      <div class='col text-center'>
        <h3 class='display-4'><?php echo lang('edit_group_heading');?></h3>
        <p class='hide'><?php //echo lang('edit_group_subheading');?></p>
      </div>
    </div>
    ...
    <div class='row table-body'>
      ...
      <div class='col-12'>
          ...
          <div class="form-group row">
            <label class="col-3 col-form-label" ><?php echo lang('edit_group_name_label', 'group_name');?></label>
            <div class="col">
          ...
          <div class="form-group row">
            <label class="col-3 col-form-label" ><?php echo lang('edit_group_desc_label', 'description');?></label>
            <div class="col">
    ...
    <div class='form-group row '>
            <div class='col-12'>
              <a class="btn btn-outline-warning pull-left btnBack" href="<?php echo site_url('auth/')?>"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
              <?php echo form_submit('submit', lang('edit_group_submit_btn'), ' class="btn btn-outline-primary pull-right" ');?>
            </div>
    </div>
