                ...
                <div class="">
                    <?php
                     ...
                     while($page_num <= $N_PAGES){
                         ?>
                         <div class="card-container d-flex flex-wrap flex-column mt-3 <?php//=($page_num > 0?'mt-3':'')?>" style="gap:35px;<?php//=($page_num>0?'35px;':'10px;')?>">
                         <?php
                            ...
                            <div class="row">
                                ...
                                <div class="col spec-col">
                                    <div class="spec-title">
                                        ...
                                        <?php echo (strlen($item['code']) > 0 ? $item['code']."<br />" : '')?>
